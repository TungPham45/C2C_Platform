...
VALUES
  (
    ...
    'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=256&q=80',
    'active',
    4.80
  ),
  (
    ...
    'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=256&q=80',
    'active',
    4.70
  ),
  (
    ...
    'https://images.unsplash.com/photo-1573855619003-97b4799dcd8b?w=256&q=80',
    'pending',
    0.00
  )
...
WITH product_rows(shop_slug, category_slug, name, slug, description, base_price, thumbnail_url, rating, sold_count, status, moderation_note) AS (
  VALUES
    ...
    (
      ...
      289000.00,
      'https://images.unsplash.com/photo-1596755094514-f87e32f6b717?w=600&q=80',
      0.00,
      0,
      'pending_approval',
      NULL
    ...
    (
      ...
      50000.00,
      'https://images.unsplash.com/photo-1572688484432-2f0b9e4ace4a?w=600&q=80',
      0,
      0,
      'rejected',
...
WITH image_rows(product_slug, image_url, is_primary, sort_order) AS (
  VALUES
    ('classic-t-shirt', 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&q=80', true, 0),
    ('classic-t-shirt', 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&q=80', false, 1),
    ('premium-hoodie', 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&q=80', true, 0),
    ('premium-hoodie', 'https://images.unsplash.com/photo-1614975058789-41316d0e2e9c?w=600&q=80', false, 1),
    ('linen-overshirt', 'https://images.unsplash.com/photo-1596755094514-f87e32f6b717?w=600&q=80', true, 0),
    ('boxer-essentials-3-pack', 'https://images.unsplash.com/photo-1505022610485-0249ba5b3675?w=600&q=80', true, 0),
    ('sneaker-runner-pro', 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80', true, 0),
    ('sneaker-runner-pro', 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=600&q=80', false, 1)
)
